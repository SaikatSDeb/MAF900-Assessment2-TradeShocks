...
| **YoY Margin Change** | `delta_opm_it` | $\\text{OPM}_{i,t} - \\text{OPM}_{i,t-4}$ | Year-over-year margin shift (percentage points), Winsorized 1%/99% |
| **Macro Crude Price** | `crude_price_3mnths` | PPAC Crude Basket | Quarterly average crude oil price (USD) |
| **Oil Shock Indicator** | `crude_shock_it` | $\\frac{P_t - P_{t-4}}{P_{t-4}} \\times 100 \\ge 15\\%$ | Binary flag for crude price increases $\\ge 15\\%$ YoY |
